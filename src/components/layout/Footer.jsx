      ...
      <div className='container'>
        <div className='footer-content'>
          <div className='footer-column brand'>
            ...
            <p>
              The advantage of hiring a workspace with us is that gives you comfortable service and all-around
              facilities.
            </p>
          </div>
          ...
          <div className='footer-column'>
            <h3 className='footer-heading'>Furniture</h3>
            <ul>
              <li>
                <Link to='/furniture/beds'>Beds</Link>
              </li>
              <li>
                <Link to='/furniture/chair'>Chair</Link>
              </li>
              <li>
                <Link to='/furniture/all'>All</Link>
              </li>
            </ul>
          </div>
              ...
              <li>
                <Link to='#'>
                  <span className='social-icon'>
                    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 320 512' className='svg-icon'>
